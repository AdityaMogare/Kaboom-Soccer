...
{
    public float minSpeed = 0.2f;    // consider "stuck" if slower than this
    public float checkTime = 0.25f;  // for this long
    public float nudgeImpulse = 0.5f;
    public LayerMask wallLayers;     // set to your Walls layer (or Default if walls are Default)
